...
-- 2022-11-21,HuiHuiChen,Created File
--**************************************************************************--
Begin Try
	Use Master;
	If Exists(Select Name From SysDatabases Where Name = 'Assignment06DB_HuiHuiChen')
	 Begin 
	  Alter Database [Assignment06DB_HuiHuiChen] set Single_user With Rollback Immediate;
	  Drop Database Assignment06DB_HuiHuiChen;
	 End
	Create Database Assignment06DB_HuiHuiChen;
End Try
Begin Catch
	Print Error_Number();
End Catch
go
Use Assignment06DB_HuiHuiChen;
...
-- Beverages	  Guaraná Fantástic 	2017-01-01	  20	  Steven Buchanan
...
AS
 ...
 From dbo.Employees as mgr
  Inner Join dbo.Employees as emp--self-joins 
